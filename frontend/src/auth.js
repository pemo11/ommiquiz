...
const supabaseUrl = process.env.OMMI_QUIZ_APP_SUPABASE_URL || 'https://zihxfkwzlxgpppzddfyb.supabase.co'
const supabaseAnonKey = process.env.OMMI_QUIZ_APP_SUPABASE_ANON_KEY || 'sb_publishable_06GTeAb6I9QWgNTOCH0LKw_H_4lzXnP'

// Get API URL for login logging
const API_URL = process.env.OMMI_QUIZ_APP_API_URL || 'http://localhost:8080/api'
