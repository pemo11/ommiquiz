...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.error('  OMMIQUIZ_APP_SUPABASE_URL (mapped to REACT_APP_SUPABASE_URL)')
  console.error('  OMMIQUIZ_APP_SUPABASE_ANON_KEY (mapped to REACT_APP_SUPABASE_ANON_KEY)')
}
