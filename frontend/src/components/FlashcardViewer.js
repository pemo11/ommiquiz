...
const getApiUrl = () => {
  ...
  if (process.env.REACT_APP_API_URL) {
    console.log('FlashcardViewer - Using environment API URL:', process.env.REACT_APP_API_URL);
  ...
  if (hostname === 'localhost' || hostname === '127.0.0.1') {
    ...
    console.log('FlashcardViewer - Using local development API URL:', apiUrl);
    return apiUrl;
  }
  ...
  console.log('FlashcardViewer - Using constructed API URL:', apiUrl);
  return apiUrl;
};
